...
// SPRING-TO-DO need to preserve commas and then check for badly formed call later (optimizing tree walk) to disallow "foo(a,b,c,)"
...
// argument;
	// SPRING-TO-DO make expression conditional with ? if want completion for when the RCURLY is missing
...
// SPRING-TO-DO cope with array types
