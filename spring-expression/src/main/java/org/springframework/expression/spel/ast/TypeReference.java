...
public class TypeReference extends SpelNodeImpl {
	...
	public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
		// SPRING-TO-DO possible optimization here if we cache the discovered type reference, but can we do that?
	...
	public void generateCode(MethodVisitor mv, CodeFlow cf) {
		// SPRING-TO-DO Future optimization - if followed by a static method call, skip generating code here
